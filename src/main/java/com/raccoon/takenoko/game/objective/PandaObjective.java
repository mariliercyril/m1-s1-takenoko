...
public class PandaObjective extends Objective {
    ...
    private Map<Color, Integer> goal;

    public PandaObjective(int green, int yellow, int pink, int value) {  // Number of bamboos of each color needed to satisfy the objective and the point-value of the objective
        super();
