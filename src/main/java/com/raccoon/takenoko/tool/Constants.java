...
public final class Constants {
	...
	public static final int MAX_AMOUNT_OF_OBJECTIVES = PF_READER.getIntProperty(FILE_NAME, "max.amount.of.objectives", 2);
	...
	public static final float NUMBER_OF_GAMES_FOR_STATS = PF_READER.getFloatProperty(FILE_NAME, "number.of.games.for.stats", 10);
}
